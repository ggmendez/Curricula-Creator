<div class="implementationStrategies view">
<h2><?php  echo __('Implementation Strategy'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($implementationStrategy['ImplementationStrategy']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($implementationStrategy['ImplementationStrategy']['name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Code'); ?></dt>
		<dd>
			<?php echo h($implementationStrategy['ImplementationStrategy']['code']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Implementation Strategy'), array('action' => 'edit', $implementationStrategy['ImplementationStrategy']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Implementation Strategy'), array('action' => 'delete', $implementationStrategy['ImplementationStrategy']['id']), null, __('Are you sure you want to delete # %s?', $implementationStrategy['ImplementationStrategy']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($implementationStrategy['Course'])): ?>
	...
	<?php
		$i = 0;
		foreach ($implementationStrategy['Course'] as $course): ?>
		<tr>
