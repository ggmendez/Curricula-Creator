<div class="topics index">
    ...
    <?php
    function findSubjectById ($subjects, $idToFind) {
        foreach ($subjects as $subject):
            if ($subject['Subject']['id'] == $idToFind) {
                return $subject;
            }
        endforeach;
    }
...
<?php foreach ($topics as $topic): ?>
    ...
    <?php echo $this->Html->link($topic['Unit']['name'], array('controller' => 'units', 'action' => 'view', $topic['Unit']['id'])); ?>
                ...
                <td>
                    <?php  
                    $theSubject = findSubjectById ($subjects, $topic['Unit']['subject_id']);
                    echo $this->Html->link($theSubject['Subject']['name'], array('controller' => 'subjects', 'action' => 'view', $topic['Unit']['subject_id']));  ?>
                </td>
                <td class="actions">
