...
<!--                <td><?php // echo h($course['Course']['id']); ?>&nbsp;</td>-->
                ...
                <td style="text-align: left;"><?php echo h($course['Course']['name']); ?>&nbsp;</td>
                ...
                <td><?php echo h($course['Course']['theory_hours']); ?>&nbsp;</td>
                <td><?php echo h($course['Course']['practice_hours']); ?>&nbsp;</td>
                <td><?php echo h($course['Course']['lab_hours']); ?>&nbsp;</td>
