...
<!--                <td><?php // echo h($course['Course']['id']); ?>&nbsp;</td>-->
                ...
                <td style="text-align: left;"><?php echo $this->Html->link(h($course['Course']['name']), array('action' => 'view', $course['Course']['id']), array('class' => 'simpleLink', 'style' => 'padding-left: 10px;')); ?>&nbsp;</td>
                
                
                
                
                <td style="width: 60px;"><?php echo h($course['Course']['code']); ?>&nbsp;</td>
                ...
                <td><?php echo h($course['Type']['name']); ?>&nbsp;</td>
                ...
                <td style="width: 40px;"><?php echo h($course['Course']['theory_hours']); ?>&nbsp;</td>
                <td style="width: 40px;"><?php echo h($course['Course']['practice_hours']); ?>&nbsp;</td>
                <td style="width: 40px;"><?php echo h($course['Course']['lab_hours']); ?>&nbsp;</td>
